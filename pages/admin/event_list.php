    ...
    <div class="row">
        ...
        <main class="col-md-10 ms-sm-auto px-md-4 py-4">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h2 class="fw-bold"><i class="bi bi-calendar-event"></i> Data Event</h2>
                                ...
                                <?php $no = $offset + 1; while ($row = mysqli_fetch_assoc($query)): ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="?p=admin_event&hapus=<?= $row['id_event'] ?>&page=<?= $cur_page ?>&search=<?= urlencode($search) ?>" class="btn btn-danger btn-sm btn-hapus"><i class="bi bi-trash"></i></a>
                                        </td>
                                    </tr>
                                <?php endwhile; ?>
                            </tbody>
