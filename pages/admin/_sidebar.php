...
?>
<nav class="col-md-2 d-none d-md-block bg-dark text-white py-2" id="adminSidebar">
    <div class="px-3 py-3 mb-1">
        <div class="d-flex align-items-center gap-2">
            <span class="bg-primary text-white rounded-2 d-inline-flex align-items-center justify-content-center p-2">
                <i class="bi bi-shield-lock-fill small"></i>
            </span>
            <div>
                <div class="text-light fw-bold small lh-sm">Admin Panel</div>
    ...
    <ul class="nav flex-column">
        <?php foreach ($menu as $item): ?>
            <?php if (isset($item['sep'])): ?>
                <li><div class="text-secondary fw-bold text-uppercase px-3 pt-3 pb-1 small"><?= $item['sep'] ?></div></li>
            <?php else: ?>
                <li class="nav-item">
