...
<div class="container pb-5">
    <!-- Banner Section -->
    <div class="position-relative rounded-4 overflow-hidden mt-4 shadow-lg ratio ratio-16x9">
        ...
        <div class="position-absolute bottom-0 start-0 end-0 p-4 p-md-5 z-1 text-white">
            ...
            <h1 class="display-5 fw-bold mb-2"><?= htmlspecialchars($event['nama_event']) ?></h1>
    ...
    <div class="row mt-5 g-4">
        <!-- Sidebar Info -->
        <div class="col-lg-4">
            <div class="sticky-md-top pt-4">
                <div class="card border-0 shadow-sm rounded-4 h-100 mb-4">
                    <div class="card-body p-4">
                        <h5 class="fw-bold mb-4">Lokasi & Waktu</h5>
                        <div class="d-flex gap-3 mb-4">
                            <div class="bg-primary bg-opacity-10 rounded-3 d-flex align-items-center justify-content-center flex-shrink-0 p-3 text-primary">
                        ...
                        <div class="d-flex gap-3 mb-4">
                            <div class="bg-danger bg-opacity-10 rounded-3 d-flex align-items-center justify-content-center flex-shrink-0 p-3 text-danger">
        ...
        <div class="col-lg-8">
            ...
            <?php if (mysqli_num_rows($tiket) > 0): ?>
                <div class="row g-3">
                    ...
                    ?>
                    <div class="col-12">
                        <div class="card border shadow-sm rounded-4 <?= $habis || $is_passed ? 'opacity-75' : '' ?>">
                            <div class="card-body p-4">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-5 text-md-end mt-3 mt-md-0">
                                        ...
                                        <?php if ($is_passed): ?>
                                            <button class="btn btn-secondary w-100 disabled rounded-pill">Event Selesai</button>
                                        <?php elseif ($habis): ?>
                                            <button class="btn btn-danger w-100 disabled rounded-pill">Tiket Habis</button>
                                        <?php elseif (isset($_SESSION['id_user']) && $_SESSION['role'] === 'user'): ?>
                                            <a href="?p=tiket_pesan&id=<?= $t['id_tiket'] ?>" class="btn btn-primary w-100 fw-bold rounded-pill py-2">Pesan Tiket</a>
                                        <?php elseif (!isset($_SESSION['id_user'])): ?>
                                            <a href="?p=login" class="btn btn-outline-primary w-100 rounded-pill">Login untuk Pesan</a>
                                        <?php else: ?>
                                            <button class="btn btn-secondary w-100 disabled rounded-pill">Hanya untuk User</button>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </div>
