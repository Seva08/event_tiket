                    ...
                    <div class="card h-100" style="border:none; border-radius:var(--r-lg); box-shadow:0 4px 20px rgba(0,0,0,0.05); overflow:hidden;">
                        <?php if($tiket['gambar']): ?>
                            <div style="position:relative; width:100%; padding-top:56.25%; overflow:hidden;">
                                <img src="uploads/<?= $tiket['gambar'] ?>" alt="<?= htmlspecialchars($tiket['nama_event']) ?>" style="position:absolute; top:0; left:0; width:100%; height:100%; object-fit:cover;">
                                <div style="position:absolute; bottom:0; left:0; right:0; background:linear-gradient(to top, rgba(0,0,0,0.85), transparent); padding:2rem 1.2rem 1rem;">
                                    <h5 class="fw-bold mb-1 lh-sm text-white" style="text-shadow:0 2px 4px rgba(0,0,0,0.5);"><?= htmlspecialchars($tiket['nama_event']) ?></h5>
                                    <div style="font-size:0.85rem; color:white; opacity:0.9; text-shadow:0 1px 2px rgba(0,0,0,0.5);">
                            ...
                            <form method="POST" action="">
                                <div class="mb-4">
                                    ...
                                    <div class="input-group" style="max-width: 200px;">
                                        ...
                                        <input type="number" class="form-control text-center fw-bold" id="qty" name="qty" value="1" min="1" max="<?= $sisa_kuota ?>" style="background:#fff; color:#212529;">
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control border-start-0 border-end-0 ps-0" id="kode_voucher" name="kode_voucher" placeholder="Masukkan kode voucher" style="box-shadow:none;">
                                        <button class="btn btn-outline-primary fw-bold" type="button" id="btn-cek-voucher" style="border-radius: 0 var(--r-md) var(--r-md) 0; border-width: 1.5px;">Cek Voucher</button>
                                    </div>
